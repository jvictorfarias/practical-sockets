...
import sockets.calculator.server.connection.ServerConnectionSingle;
import sockets.calculator.server.model.ServerModel;

import java.io.IOException;
import java.net.ServerSocket;

public class ServerControllerSingle {
    private ServerModel server;
    private ServerSocket listenSocket;

    public ServerControllerSingle(String addr, int port) {
    ...
    private void callServer() {
        try {
            ...
            while (true) {
                new ServerConnectionSingle(this.getListenSocket().accept());
            }
        } catch (IOException e) {
